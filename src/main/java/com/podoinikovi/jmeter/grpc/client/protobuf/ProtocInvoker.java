package com.podoinikovi.jmeter.grpc.client.protobuf;
...
public class ProtocInvoker {
    ...
    public static ProtocInvoker forConfig(String protoDiscoveryRoot, List<String> includePathsList) {
        Preconditions.checkArgument(!protoDiscoveryRoot.isEmpty(),
                "A proto discovery root is required for proto analysis");
        Path discoveryRootPath = convertPathToFullIfNonAbsolute(protoDiscoveryRoot);
        ...
        for (String includePathString : includePathsList) {
            Path path = convertPathToFullIfNonAbsolute(includePathString);
    ...
    public FileDescriptorSet invoke() throws ProtocInvocationException {
        ...
        ImmutableList<String> protocArgs = ImmutableList.<String>builder()
                ...
                .add("--include_imports")
                //.add("--include_source_info") //for documentation
                .build();
